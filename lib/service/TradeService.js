...
const addTrade = async ( data )=> {
    ...
    try {
        ...
        if ( existingTickerPortfolio ) {
            ...
            console.error( 'Nothing to sell any shares for this Ticker' );
            return;
...
const resetTrade = async ( trade ) => {
    ...
    try {
        ...
        if ( !tradeData ) {
            ...
            console.error( `Trade( ${trade} ) doesn't exists. Cannot reset this trade as we have no records of it.` );
            return;
        ...
        if ( updatedPortfolioHistory.sharesQty < 0 || updatedPortfolioHistory.avgBuyPrice < 0 ) {
            ...
            console.error( `Cannot make reset this Trade( ${trade} ). It is either making shares quantity or avg Buy Price to negative` );
            return;
        ...
        if ( updatedPortfolioHistory.sharesQty == 0 ) {
            ...
            if ( !deletedCount ) {
                ...
                console.error( `Unable to delete portfolio of this Ticker( ${tickerSymbol} )` );
                return;
...
const updateTrade = async ( id, data ) => {
    ...
    try {
        ...
        if ( updatedPortfolioHistory.sharesQty < 0 || updatedPortfolioHistory.avgBuyPrice < 0 ) {
            ...
            console.error( `Cannot update this Trade( ${ id } ). It is either making shares quantity or avg Buy Price to negative` );
            return;
